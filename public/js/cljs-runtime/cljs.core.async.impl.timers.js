...
var i_14161 = (0);
while(true){
if((i_14161 < arr.length)){
(arr[i_14161] = null);

var G__14167 = (i_14161 + (1));
i_14161 = G__14167;
continue;
} else {
}
...
var i_14186 = (self__.level + (1));
while(true){
if((i_14186 <= (new_level + (1)))){
(update[i_14186] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_14193 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_14193[i]));
} else {
x__$2.forward.push((((i < links_14193.length))?(links_14193[i]):null));
}

if((i < links_14193.length)){
(links_14193[i] = x__$2);
} else {
links_14193.push(x__$2);
}
...
var links_14226 = (update[i_14218]).forward;
if((x__$1 === (((i_14218 < links_14226.length))?(links_14226[i_14218]):null))){
(links_14226[i_14218] = (x__$1.forward[i_14218]));

var G__14227 = (i_14218 + (1));
i_14218 = G__14227;
continue;
} else {
var G__14228 = (i_14218 + (1));
i_14218 = G__14228;
continue;
}
} else {
